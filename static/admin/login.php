...
<head>
  ...
  <!-- Title -->
  <title>Amman Foods Admin Login</title>
          ...
          <div class="card-body">
            ...
            <form action="authenticate.php" method="post">
              <div class="text-center">
                <div class="mb-5">
                  <h1 class="display-5">Admin Sign in</h1>
			  ...
			  <?php 
				...
				if ($error_id == 1) {
				echo '<center><strong><p class="text-danger">'.$errors[$error_id].'</p></strong></center>';
				}elseif ($error_id == 2) {
				echo '<center><strong><p class="text-danger">'.$errors[$error_id].'</p></strong></center>';
				}
    			?>
              ...
              <div class="mb-4">
                ...
                <input class="form-control form-control-lg" type="email" name="email" id="signinSrEmail" tabindex="1" placeholder="email@address.com" aria-label="email@address.com" required>
              ...
              <div class="mb-4">
                ...
                <div class="input-group input-group-merge" data-hs-validation-validate-class>
                  <input class="js-toggle-password form-control form-control-lg" type="password" name="password" id="signupSrPassword" placeholder="8+ characters required" aria-label="8+ characters required" required minlength="8" data-hs-toggle-password-options='{
...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.0/authentication-login-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 07 Aug 2022 19:39:36 GMT -->
</html>