		...
		<!-- Page Header -->
		  <div class="page-header">
			<div class="row align-items-center">
			  ...
			  <div class="col-auto">
				<a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#AddCategories">
				  <i class="bi-plus-circle me-1"></i> New Categories
				</a>
			  </div>
			  <!-- Modal -->
				<div class="modal fade" id="AddCategories" data-bs-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
				  <div class="modal-dialog" role="document">
					<div class="modal-content">
					  ...
					  <div class="modal-footer">
						...
						<button type="submit" name="AddNewCategory" class="btn btn-primary">Save</button>
					  </div>
					</div>
				  </div>
				</div>
					  ...
					  <div class="col-auto">
						...
						<form>
						  ...
						  <div class="input-group input-group-merge input-group-flush">
							...
							<input id="datatableWithSearchInput" type="search" class="form-control" placeholder="Search Categories" aria-label="Search Categories">
						  </div>
						  <!-- End Search -->
						</form>
						<!-- End Filter -->
						...
						<td>
							<?php
								if ($category_status == "1") { ?>
								  <a class="btn btn-success btn-sm" href="adminaction.php?Disablecat=<?php echo $category_id;?>" class="link-sm link-secondary small lead" onclick="return confirm('Are you sure you want to disable the Category ?');">
										Active
									</a>
								<?php } else { ?>
								  <a class="btn btn-danger btn-sm" href="adminaction.php?Enablecat=<?php echo $category_id;?>" class="link-sm link-secondary small lead" onclick="return confirm('Are you sure you want to enable this Category ?');">
										In-Active
									</a>
								<?php }
							?>
